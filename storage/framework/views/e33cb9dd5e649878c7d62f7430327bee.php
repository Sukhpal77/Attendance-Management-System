...
<div class="font-bold text-xl text-green-600">Class -
    <span class="font-extrabold"><?php echo e($batch->batch_name ?? 'No Batch Selected'); ?></span>
</div>
...
<div class="w-full h-5/6 flex justify-center content-center  ">
    <div class="flex flex-col w-full h-4/6  max-w-5xl my-10 mx-auto bg-white shadow-lg rounded-lg ">
        ...
        <div class="flex flex-col border-t border-gray-200 ">
            <form action="<?php echo e(route('storeDateSheet')); ?>" method="POST" class="p-6" id="storeDateSheet">
                <?php echo csrf_field(); ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-6 ">
                                    ...
                                    <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a href="#"
                                                ...
                                                data-value="<?php echo e($subject->id); ?>"><?php echo e($subject->subject_name); ?></a>
                                        </li>
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <input id="batch_name" name="batch_name" value="<?php echo e($batch->batch_name ?? ''); ?>" readonly
                            ...
                            required>
                        <input type="hidden" id="batch_id" value="<?php echo e($batch->id ?? ''); ?>">
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('teacher.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel project\attendance-Management\resources\views/teacher/addDateSheet.blade.php ENDPATH**/ ?>
...
<form class="w-5/6 h-5/6 justify-center items-center flex rounded-lg shadow-xl  bg-blend-lighten"
    action="<?php echo e(route('StudentSave')); ?>" method="POST" id="StudentForm">
    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel project\attendance-Management\resources\views/admin/addStudent.blade.php ENDPATH**/ ?>
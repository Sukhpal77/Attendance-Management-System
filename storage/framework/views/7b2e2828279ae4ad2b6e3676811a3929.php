...
<form class="w-5/6 h-5/6 justify-center items-center flex rounded-lg shadow-xl bg-blend-lighten"
    action="<?php echo e(route('AdminSave')); ?>" method="POST" id="adminForm1">
    <?php echo csrf_field(); ?>
    ...
    <div class="w-3/5 h-full flex flex-col justify-center items-center border-b border-green-600 ">
        ...
        <div class=" relative border-green-60 overflow-y-auto overflow-x-hidden no-scrollbar">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                    <label for="qualification"
                        class="block text-sm font-medium leading-6 text-green-600">Qualification</label>
                    <div class="mt-2 w-72">
                ...
                <div class="sm:col-span-3">
                    <label for="position" class="block text-sm font-medium leading-6 text-green-600">Position</label>
                    <div class="mt-2">
                ...
                <div class="sm:col-span-full flex justify-end gap-x-6 pt-7 pb-7">
                    ...
                    <button type="button" class="text-sm font-semibold leading-6 text-gray-900 ">
                        <a href="<?php echo e(route('cancelTB')); ?>"
                            class="rounded-md text-green-500 px-3  py-2 text-sm font-semibold hover:text-white hover:bg-green-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Cancel</a>
                    </button>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel project\attendance-Management\resources\views/admin/addAdmin.blade.php ENDPATH**/ ?>
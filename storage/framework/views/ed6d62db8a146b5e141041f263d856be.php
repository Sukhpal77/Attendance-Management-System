...
<form class="w-5/6 h-5/6 justify-center items-center flex rounded-lg shadow-xl bg-blend-lighten"
    action="<?php echo e(route('SubjectSave')); ?>" method="POST" id="SubjectForm">
    <?php echo csrf_field(); ?>
        ...
        <div class="w-1/2 px-10">
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6 ">
                    <button type="button" class="text-sm font-semibold leading-6 text-gray-900 ">
                        <a href="<?php echo e(route('SubjectForm')); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel project\attendance-Management\resources\views/admin/addsubject.blade.php ENDPATH**/ ?>
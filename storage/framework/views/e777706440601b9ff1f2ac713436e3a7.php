...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('password.update')); ?>" id="update-password-form">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH D:\laravel project\attendance-Management\resources\views/profile/partials/update-password-form.blade.php ENDPATH**/ ?>
...
<div class="p-4 w-full h-full">
    <form action="<?php echo e(route('submitAttendance')); ?>" method="POST" id="attendance-form" class="h-full ">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="teacher_id" value="<?php echo e($timeTableEntry->teacher_id); ?>">
        <input type="hidden" name="subject_id" value="<?php echo e($timeTableEntry->subject_id); ?>">
        <input type="hidden" name="course_id" value="<?php echo e($timeTableEntry->course_id); ?>">
        <input type="hidden" name="batch_id" value="<?php echo e($timeTableEntry->batch_id); ?>">
        <input type="hidden" name="day" value="<?php echo e($timeTableEntry->day); ?>">
                ...
                <tbody>
                    <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="bg-white border-b hover:bg-gray-50">
                            <td class="w-4 p-4">
                                <div class="flex items-center">
                                    <input id="<?php echo e($student->id); ?>" type="checkbox"
                                        name="attendance[<?php echo e($student->id); ?>]" value="true" class="bg-breen-600 rounded border-green-300 text-green-600 shadow-sm focus:ring-0">
                                    <input type="hidden" id="hidden-<?php echo e($student->id); ?>" name="attendance[<?php echo e($student->id); ?>]" value="false" />
                                    <label for="<?php echo e($student->id); ?>" class="custom-checkbox"></label>
                                </div>
                            </td>
                            <th scope="row" class="flex items-center px-6 py-2 text-gray-500 whitespace-nowrap">
                                <div class="ps-3">
                                    <div class="text-base font-semibold"><?php echo e($student->first_name); ?></div>
                                    <div class="font-normal text-gray-500"><?php echo e($student->id); ?></div>
                                </div>
                            </th>
                            <td class="px-6 py-2"><?php echo e($timeTableEntry->subject_name); ?></td>
                            <td class="px-6 py-2"><?php echo e($timeTableEntry->batch); ?></td>
            ...
            $('#attendance-form').on('submit', function (event) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('teacherTimeTable', ['day' => $timeTableEntry->day])); ?>";
                        }, 2000); 
                    },
...
<?php echo $__env->make('teacher.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel project\attendance-Management\resources\views/teacher/attendance.blade.php ENDPATH**/ ?>
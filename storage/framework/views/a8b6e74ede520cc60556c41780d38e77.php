        ...
        <nav class=" w-1/6 h-full shadow-2xl rounded-lg content-between flex flex-col items-center  justify-around ">
            ...
            <div class="flex flex-col my-16 w-full items-center">
                ...
                <div
                    ...
                    <a href=<?php echo e(route('adminTimeTable')); ?>
                ...
                <div
                    ...
                    <a href=<?php echo e(route('admin.updateProfile')); ?>
                ...
                <div
                    ...
                    <a href=<?php echo e(route('admin.updateAttendance')); ?>  class="w-full h-full text-center items-center justify-evenly flex ">Update
                        Addendance</a></div>
                                ...
                                <ul class="py-2">
                                    ...
                                    <li>
                                        <div
                                            ...
                                            <a href="<?php echo e(route('Reset.pass')); ?>"
                                    ...
                                    <li>
                                        <div
                                            class="  text-green-600 hover:text-white hover:bg-green-600 rounded-lg flex ">
                                            <a href="<?php echo e(route('AdminForm')); ?>"
...
</html><?php /**PATH D:\laravel project\attendance-Management\resources\views/admin/layout.blade.php ENDPATH**/ ?>
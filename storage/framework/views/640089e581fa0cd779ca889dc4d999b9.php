...
<?php if($userrole == 'teacher' || $userrole == 'admin'): ?>
    <a href="<?php echo e(route($userrole . '.events.create')); ?>"
        ...
        ADD Event</a>
<?php endif; ?>  <div class="w-5/6 h-5/6 rounded-lg shadow-xl md-9 px-10 py-8 top-0 ">
                        ...
                        <div class="relative z-10 mx-auto max-w-md ">
                            ...
                            <div
                                ...
                                <h1
                                    ...
                                    <?php echo e($event->heading); ?>

                                </h1>
                                <p class="w-full h-28 overflow-y-scroll no-scrollbar "><?php echo e($event->description); ?></p>
                            </div>
                            <div
                                ...
                                <p>Time : <?php echo e($event->time); ?></a>
                                </p>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($userrole . '.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel project\attendance-Management\resources\views/event/event.blade.php ENDPATH**/ ?>
...
<body class="w-full h-screen p-1 ">
    <div class="w-full h-full flex flex-row ">
        ...
        <nav class=" w-1/6 h-full shadow-2xl rounded-lg content-between flex flex-col items-center  justify-around ">
            <div class=" w-20 my-4 cursor-pointer font-bold text-xl text-green-600 hover:w24">
            <img src="{{ asset('img/logo.png') }}" alt="Logo">
            </div>
            <div class="flex flex-col my-16 w-full items-center">

                <div class="TimeTable cursor-pointer font-bold sm:text-xl text-white bg-green-600 w-full h-16 rounded-lg "><a
                        href={{ route('teacherTimeTable') }}
                        class="w-full h-full text-center items-center justify-evenly flex ">TimeTable</a></div>
                
                <div class="Attendance cursor-pointer font-bold sm:text-xl text-green-600 w-full h-16 rounded-lg hover:bg-gray-100"><a
                        href={{ route('autoSelectedBatch') }}
                        class="w-full h-full text-center items-center justify-evenly flex ">Attendance</a></div>

                <div class="Events cursor-pointer font-bold sm:text-xl text-green-600 w-full h-16 rounded-lg hover:bg-gray-100"><a
                        href={{ route('events.show')}}
                        class="w-full h-full text-center items-center justify-evenly flex ">Event</a></div>

                <div class="DateSheet cursor-pointer  font-bold sm:text-xl text-green-600 w-full h-16 rounded-lg hover:bg-gray-100"><a
                        href={{ route('getDateSheet') }}  
                        class="w-full h-full text-center items-center justify-evenly flex">DateSheet</a></div>
                        
                <div class="Result cursor-pointer  font-bold sm:text-xl text-green-600 w-full h-16 rounded-lg hover:bg-gray-100"><a
                        href={{ route('showResultAllStudent') }} 
                            ...
                            <ul class="py-2">
                                    <li>
                                        <div class="flex   text-green-600 hover:text-white hover:bg-green-600 rounded-lg">
                                              <a href="{{ route('Profile') }}" class=" text-justify block w-full px-4 py-2  ">Profile</a>
                                        </div>      
                                    </li>
                                    <li>
                                        <div class="  text-green-600 hover:text-white hover:bg-green-600 rounded-lg flex ">
                                             <a href="{{ route('Reset.pass') }}" class="text-justify block w-full px-4 py-2">Reset Password</a>
                                        </div>     
                                    </li>
                                    <li>
